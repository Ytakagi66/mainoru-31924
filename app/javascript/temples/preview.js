  ...
  document.addEventListener('DOMContentLoaded', function(){
    ...
    const createImageHTML = (blob) => {
      ...
      // ファイル選択ボタンを生成
        ...
        inputHTML.setAttribute('id', `temple_image_${imageElementNum}`)
        inputHTML.setAttribute('name', 'temple[images][]')
        ...
        spanHTML.setAttribute('id', `temple_span_${imageElementNum}`)
    ...
    document.getElementById('temple_image').addEventListener('change', function(e){
